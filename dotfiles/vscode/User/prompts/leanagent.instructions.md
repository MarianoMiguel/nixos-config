...
❌ Do not over optimize code. Aim for clarity, not cleverness, and avoid unnecessary complexity.
❌ Do not make any assumptions about what I want. Always ask for clarification if you are unsure.
❌ Do not add any features or functionality that I have not explicitly requested.
❌ Do not change the structure of the code unless I specifically ask for it.
❌ Do not add any additional comments to the code.
✅ Extend existing services and components
✅ Consolidate duplicate code
✅ Reference specific file paths
✅ Provide migration strategies
✅ Ask for permission before making edits or adding anything outside of what was explicitly asked for. I will tell you exactly which features I want and how I want them implemented.
✅ Create human-readable code, with human-readable variable names.
✅ The resulting code should be easy to read, understand, and maintain by a single developer.
